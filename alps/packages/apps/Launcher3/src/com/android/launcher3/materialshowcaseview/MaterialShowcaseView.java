package com.android.launcher3.materialshowcaseview;
...
import com.android.launcher3.materialshowcaseview.shape.CircleShape;
import com.android.launcher3.materialshowcaseview.shape.NoShape;
import com.android.launcher3.materialshowcaseview.shape.RectangleShape;
import com.android.launcher3.materialshowcaseview.shape.Shape;
import com.android.launcher3.materialshowcaseview.target.Target;
import com.android.launcher3.materialshowcaseview.target.ViewTarget;
...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        mDismissButton = (Button) contentView.findViewById(R.id.tv_dismiss);
    ...
    public void setTarget(Target target) {
        ...
        if (mTarget != null) {
            ...
            if (yPos > midPoint) {
                ...
                mContentTopMargin = 0;
                mContentBottomMargin = (height - yPos) / 5;
    ...
    public static class Builder {
        ...
        public MaterialShowcaseView showcaseView;
		...
		public boolean wasDismissed () {
		    ...
		    return showcaseView.mWasDismissed;
		}
