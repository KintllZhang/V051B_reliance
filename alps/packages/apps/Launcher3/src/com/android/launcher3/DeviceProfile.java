...
public class DeviceProfile {
    ...
    private void updateIconSize(float scale, int drawablePadding, Resources resources,
        ...
        //begin, liyong for app name two line display
        //cellHeightPx = iconSizePx + iconDrawablePaddingPx + (int) Math.ceil(fm.bottom - fm.top);
        cellHeightPx = iconSizePx + iconDrawablePaddingPx + 2*(int) Math.ceil(fm.bottom - fm.top);
        //end, liyong for app name two line display
