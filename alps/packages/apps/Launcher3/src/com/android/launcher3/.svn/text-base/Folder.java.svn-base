...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        /**M: changed to resolve the folder can't scroll issue.@{**/
        /*
        if (LauncherAppState.isDisableAllApps()) {
            ...
            Log.d(TAG, "mContent.getDesiredHeight() = " + mContent.getDesiredHeight());
        } else {
        ...
        */
        mContent.setFixedSize(getContentAreaWidth(), mContent.getDesiredHeight());
        Log.d(TAG, "mContent height = " + mContent.getHeight());
        /**@}*/
