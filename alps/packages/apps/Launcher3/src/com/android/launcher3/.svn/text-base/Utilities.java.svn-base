...
import java.util.Calendar;//add:by Vsun:Famas for Calendar
import android.graphics.drawable.NinePatchDrawable;//add:by Vsun:Famas for Calendar
import android.graphics.Typeface;//add:by Vsun:Famas for Calendar
/**
...
static Bitmap createCalendarIconBitmap(Drawable icon, Context context){  
        ...
        String dayString  = String.valueOf(Calendar.getInstance().get(Calendar.DAY_OF_MONTH));  
         ...
         String weekStrings[] = context.getResources().getStringArray(R.array.week_days);  
         String weekString = weekStrings[dayOfWeek-1];  
        Log.d("createCalendarIconBitmap","weekString"+weekString);
        ...
        synchronized (sCanvas) {  
           ...
           Paint mWeekPaint = new Paint();  
            ...
            mWeekPaint.setColor(0xffffffff);  
            ...
            mDatePaint.setColor(0xff1d83f3);  
